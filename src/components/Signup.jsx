...
function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      setErrorMessage(error.message);  // Show the error message
        ...
        <div className="flex justify-center h-screen">
          <div className="hidden bg-cover lg:block lg:w-2/3">
            <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-40 bk-img">
              <div>
                <h2 className="text-2xl font-bold text-white sm:text-3xl">Welcome to FoodieWeb</h2>
                <p className="max-w-xl mt-3 text-gray-300">
                  Join us today to explore exciting recipes, restaurant recommendations, and more. Sign up now!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
            <div className="flex-1">
              <div className="text-center">
                ...
                <p className="mt-3 text-gray-500 dark:text-gray-300">Create an account to get started</p>
              </div>
              ...
              <div className="mt-8">
                <form onSubmit={handleSignup}>
                  ...
                  <div className="mt-6">
                    <label htmlFor="confirm-password" className="block mb-2 text-sm text-gray-600 dark:text-gray-200">
                      Confirm Password
                    </label>
                    <input
                      type="password"
                  ...
                  <div className="mt-6">
                    <button
                      type="submit"
                      className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform bg-brightColor rounded-lg hover:bg-opacity-90 transation-all focus:outline-none focus:bg-orange-400 focus:ring focus:ring-orange-300 focus:ring-opacity-50"
                    >
                      Sign Up
                    </button>
                  </div>
