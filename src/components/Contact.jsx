  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="max-w-xl w-full mx-auto px-6 py-12">
        <h1 className="text-4xl font-semibold text-center text-orange-600 mb-6">Contact Us</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 mt-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
              ...
              <button
                type="submit"
                className="w-full py-3 bg-orange-600 text-white font-semibold rounded-md shadow-md hover:bg-orange-700"
              >
                Send Message
              </button>
            </form>
